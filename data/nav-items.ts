...
export const navItems: NavItem[] = [
  ...
  { href: "/preparation", label: "賽前準備", shortLabel: "準備", icon: ClipboardCheck },
  { href: "/records", label: "紀錄與回報", shortLabel: "紀錄", icon: FileText },
  { href: "/transfer", label: "後送與應變", shortLabel: "應變", icon: Ambulance },
  { href: "/sports", label: "單項競賽規則", shortLabel: "規則", icon: Shield },
  { href: "/emergency", label: "場邊急症處理", shortLabel: "急症", icon: HeartPulse },
