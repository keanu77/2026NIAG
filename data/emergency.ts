...
export const scenarioQuestions = [
  {
    question:
      "跆拳道選手胸口遭受撞擊後倒地，無脈搏且呼吸停止，第一步最適合是？",
    options: [
      "先抬到場邊",
      "啟動 EAP 並開始 CPR",
      "先詢問教練是否回場",
    ...
    answer: 1,
    explanation: "符合 Commotio Cordis 情境，應立即啟動 EAP、CPR 並準備 AED。",
  },
  {
    question: "選手在高溫環境下出現意識改變，最優先處置為何？",
    options: [
      "補充葡萄糖",
      "先讓他坐著休息",
      "迅速降溫與安排轉送",
    ...
    answer: 2,
    explanation: "熱中暑的核心是神經症狀加上高熱，需立即快速降溫。",
  },
  {
    question: "頭部創傷後短暫喪失意識但目前可活動，當天是否可回場？",
    options: [
      "可以，只要本人同意",
      "可以，只要教練同意",
      "不可以",
    ...
    answer: 2,
    explanation: "教材明確指出短暫喪失意識者當天不可回場。",
  },
  {
    question: "懷疑張力性氣胸時，下列哪一項屬於紅旗徵象？",
    options: ["單純咳嗽", "靜脈怒張與氣管偏移", "僅有肌肉痠痛", "僅有胸壁擦傷"],
    answer: 1,
    explanation: "張力性氣胸教材特別列出靜脈怒張與氣管偏移為危險徵象。",
  },
  {
    question: "選手出現呼吸急促、全身蕁麻疹與低血壓，最優先的藥物處置為？",
    options: [
      "口服止痛藥",
      "肌肉注射 Epinephrine（Epi-pen）",
      "冰敷患處",
      "補充運動飲料",
    ],
    answer: 1,
    explanation:
      "過敏性休克（Anaphylaxis）需立即使用 Epi-pen，同時給予抗組織胺並轉送急診。",
  },
  {
    question:
      "選手跌倒後前臂明顯變形且有撕裂傷，骨頭外露，下列何者為最適當處置？",
    options: [
      "嘗試將骨頭推回並包紮",
      "以濕紗布覆蓋傷口後夾板固定",
      "僅用冰敷觀察",
    ...
    answer: 1,
    explanation:
      "開放性骨折應以濕紗布覆蓋傷口、軸向牽引後夾板固定，不可嘗試復位外露骨頭。",
  },
  {
    question:
      "戶外田徑比賽中聽到雷聲，距離上次閃電不到 30 秒，應採取什麼行動？",
    options: [
      "繼續比賽但提高警覺",
      "立即停止戶外活動並疏散至室內",
      "只要求選手蹲下即可",
    ...
    answer: 1,
    explanation:
      "30-30 rule：閃電到雷聲間隔 < 30 秒時應立即停止戶外活動，最後一次雷聲後等 30 分鐘才可恢復。",
  },
  {
    question:
      "受傷選手要求回場比賽，教練也極力要求讓他上場，身為場邊醫護人員，最適當的做法是？",
    options: [
      "教練有最終決定權，讓選手回場",
      "先完成醫療評估，以運動員福祉為優先做出判斷",
      "讓選手自己決定",
      "直接拒絕不做評估",
    ],
    answer: 1,
    explanation:
      "場邊倫理義務要求以運動員福祉為優先，不受教練或比賽壓力影響回場決策。",
  },
];
