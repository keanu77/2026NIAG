...
import {
  ...
  defaultTrees,
} from "@/components/emergency-decision-tree";
              ...
              {headInjuryFlow.map((item) => (
                ...
                >
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div
                      className={`rounded-full px-3 py-1 text-xs font-semibold ${item.disposition.includes("立即") ? "bg-rose-100 text-rose-800" : "bg-amber-100 text-amber-900"}`}
                    >
                      {item.disposition}
                    </div>
                  </div>
