          ...
          <div className="grid gap-8 xl:grid-cols-[1.2fr_0.8fr] xl:items-center">
            <div className="space-y-5">
              ...
              <p className="max-w-3xl text-sm leading-7 text-white/85 md:text-base">
                ...
                與場邊防護員使用的互動課程網站，整合賽事總覽、角色分工、賽前準備、後送應變、單項競賽規則與場邊急症處理。
              </p>
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/overview"
                  className="inline-flex items-center rounded-2xl bg-white px-5 py-3 text-sm font-semibold text-slate-900"
                >
                  開始學習 <ChevronRight className="ml-1 h-4 w-4" />
                </Link>
                <Link
                  href="/emergency"
                  className="inline-flex items-center rounded-2xl border border-white/30 px-5 py-3 text-sm font-semibold text-white"
                >
                  進入場邊急症模組
                </Link>
                <Link
